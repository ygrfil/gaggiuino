...
namespace {
  ...
  const profileDefaults_t defaultsProfile[MAX_PROFILES] = {
    ...
    {"Thick Syrup",/*pi*/true, true, 0, 0.f, 1.5f, 8, 3.f, 0.f, 0, false, 0.f,/*sk*/true, 0, 6, 0.f, 1.0f, 0.f, 0.f, 0.f, 1, 2,/*tp*/false, false, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, true, 0.f, 0.f, 0, 0, 0.f, 1.0f, 1.5f, 30, 0, 10.f,/*other*/ 94, false, 18.f, 0.f, 2},  // profile 2 - Ultra slow flow for thick body
    {"Thick Ristretto",/*pi*/true, false, 4, 3.f, 0.f, 0, 0.f, 0.f, 0, false, 0.f,/*sk*/false, 0, 0, 0.f, 0.f, 0.f, 0.f, 0.f, 2, 2,/*tp*/true, false, 3.f, 10.f, 2, 0.f, 4, 0, 1.5f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, false, 10.f, 8.f, 18, 0, 1.5f, 0.f, 0.f, 0, 0, 0.f,/*other*/ 92, false, 18.f, 0.f, 2},  // profile 3 - High pressure concentrated shot
    {"Thick Bloom",/*pi*/true, true, 0, 0.f, 1.0f, 10, 3.f, 0.f, 0, false, 0.f,/*sk*/true, 0, 12, 0.f, 0.8f, 0.f, 0.f, 0.f, 1, 2,/*tp*/false, false, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, true, 0.f, 0.f, 0, 0, 0.f, 0.8f, 1.2f, 35, 0, 10.f,/*other*/ 93, false, 18.f, 0.f, 2}  // profile 4 - Long bloom for maximum extraction
  };
}
