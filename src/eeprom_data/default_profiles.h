...
namespace {
  ...
  const profileDefaults_t defaultsProfile[MAX_PROFILES] = {
    {"Rao Best Practice",/*pi*/true, true, 0, 0.f, 3.f, 5, 3.f, 0.f, 600, true, 0.f,/*sk*/true, 8, 8, 0.f, 0.f, 4.f, 0.f, 0.f, 1, 2,/*tp*/true, false, 4.f, 9.f, 0, 0.f, 6, 0, 0.f, 0.f, 2.5f, 0, 9.f, 6, 0, 9.f,/*pf*/true, true, 0.f, 0.f, 20, 0, 2.5f, 2.5f, 2.f, 20, 0, 9.f,/*other*/ 92, true, 18.f, 0.f, 2},  // profile 0
    {"Classic 9 Bar",/*pi*/false, false, 0, 0.f, 0.f, 0, 0.f, 0.f, 0, false, 0.f,/*sk*/false, 0, 0, 0.f, 0.f, 0.f, 0.f, 0.f, 0, 0,/*tp*/false, false, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, false, 9.f, 9.f, 0, 0, 0.f, 0.f, 0.f, 0, 0, 0.f,/*other*/ 93, true, 18.f, 0.f, 2},  // profile 1
    {"Light Roast Flow",/*pi*/true, true, 0, 0.f, 4.f, 6, 2.5f, 0.f, 0, false, 0.f,/*sk*/false, 0, 0, 0.f, 0.f, 0.f, 0.f, 0.f, 1, 2,/*tp*/false, false, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, true, 0.f, 0.f, 0, 0, 0.f, 2.5f, 3.5f, 25, 0, 9.f,/*other*/ 94, true, 20.f, 0.f, 2},  // profile 2
    {"Blooming Espresso",/*pi*/true, true, 0, 0.f, 4.f, 20, 7.f, 0.f, 650, true, 0.f,/*sk*/true, 0, 30, 0.f, 0.f, 0.6f, 0.f, 5.f, 5, 2,/*tp*/true, true, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 2.f, 2.f, 1, 9.f, 0, 4, 9.f,/*pf*/true, true, 0.f, 0.f, 0, 0, 0.f, 2.f, 2.f, 15, 0, 6.f,/*other*/ 93, true, 18.f, 0.f, 2},  // profile 3
    {"Dark Roast Comfort",/*pi*/true, false, 4, 2.5f, 0.f, 0, 0.f, 0.f, 600, false, 0.f,/*sk*/false, 0, 0, 0.f, 0.f, 0.f, 0.f, 0.f, 3, 2,/*tp*/true, false, 2.5f, 6.5f, 2, 0.f, 3, 0, 0.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, false, 6.5f, 6.f, 22, 0, 2.f, 0.f, 0.f, 0, 0, 0.f,/*other*/ 88, true, 19.f, 0.f, 2}  // profile 4
  };
}
